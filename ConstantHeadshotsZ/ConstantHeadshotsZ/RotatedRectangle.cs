...
namespace ConstantHeadshotsZ
{
    public class RotatedRectangle
    {
        ...
        public RotatedRectangle(Rectangle theRectangle, float theInitialRotation, Vector2 theOrigin)
        {
            CollisionRectangle = theRectangle;
            Rotation = theInitialRotation;
            Origin = theOrigin;
        ...
        public void TestDraw(SpriteBatch spriteBatch, ContentManager Content)
        {
            spriteBatch.Draw(Content.Load<Texture2D>("White"), new Rectangle(X, Y, Width, Height), null, Color.Red, Rotation, Origin, SpriteEffects.None, 0f);
        }
    }
}
