...
namespace ConstantHeadshotsZMP
{
    ...
    public class Level
    {
        ...
        public void Update(Player[] players, ContentManager Content, Player player)
        {
            if (drops.Length != 0)
            {
            ...
            if (zombies != null)
            {
                ...
                for (int i = 0; i < zombies.Length; i++)
                {
                    ...
                    else
                    {
                        ...
                        zombies[i].Update(players, this, i);
                    }
                }
            ...
            if (spawnTimer <= 0)
            {
                if (zombies.Length <= maxAmountOfZombies)
                {
                    ...
                    if (zombies.Length != 0)
                    {
                        ...
                        Zombie newZombie = new Zombie(new Sprite(Content.Load<Texture2D>("Player"), randomZombieSpawner, Color.Green), 0, Content, players);
            ...
            if (zombies.Length != 0)
            {
                ...
                {
                    if (playerCollidesWithZombiesPixel(player2) && player2.delayUntilHit == 0)
                    {
                        player2.health -= 7;
                        player2.delayUntilHit = 30;
                    }
                }
            }
        }
        ...
        */
        ...
        public bool zombieCollidesWithUncollidable(Zombie zombie, Vector2 oldVector)
        {
            if (zombieCollidesWithSolidsPixel(zombie, oldVector))
            {
                return true;
        ...
        */
        ...
        public void Draw(SpriteBatch spriteBatch, ContentManager Content, Player player)
        {
